...
namespace TokenSongTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class TokenSongContractTests : IClassFixture<CheckpointFixture<TokenSongContractTests>>
    {
        ...
        public TokenSongContractTests(CheckpointFixture<TokenSongContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<TokenSongContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<TokenSongContract>(c => c.changeNumber(42));
